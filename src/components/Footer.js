export default function Footer() {
    return (
        <footer className="w-full py-8 bg-gray-50 border-t border-gray-200 mt-auto">
            <div className="max-w-7xl mx-auto px-4 flex flex-col items-center justify-center text-center space-y-3 text-sm text-gray-500">
                <p className="font-medium text-gray-900">
                    Made with ❤️ by the SMST Organizing Team
                </p>
